...
public class EinstellungImpl extends AbstractDBObject implements Einstellung {
  ...
  /**
   * Variable, in der gespeichert wird, ob für den Verein Zusatzfelder vorhanden sind.
   */
  private Boolean hasZus = null;

  /**
   * settings speichert Benutzer-Präferenzen in einer config-Datei. Sie unterscheiden sich also auf
   * jedem System und hängen nicht an der DB.
   */
  ...
  public Konto getHibiscusKonto() throws RemoteException {
    try {
      // DB-Service holen
      DBService service =
          (DBService) Application.getServiceFactory().lookup(HBCI.class, "database");
  ...
  public void setEintrittsdatumPflicht(Boolean eintrittsdatumpflicht) throws RemoteException {
    setAttribute("eintrittsdatumpflicht", Boolean.valueOf(eintrittsdatumpflicht));
  }
  ...
  public void setSekundaereBeitragsgruppen(Boolean sekundaerebeitragsgruppen)
    ...
    setAttribute("sekundaerebeitragsgruppen", Boolean.valueOf(sekundaerebeitragsgruppen));
  }
  ...
  public void setKursteilnehmerGebGesPflicht(Boolean kursteilnehmergebgespflicht)
      throws RemoteException {
    setAttribute("kursteilnehmergebgespflicht", Boolean.valueOf(kursteilnehmergebgespflicht));
  }
  ...
  public void setDokumentenspeicherung(Boolean dokumentenspeicherung) throws RemoteException {
    setAttribute("dokumentenspeicherung", Boolean.valueOf(dokumentenspeicherung));
  }
  ...
  public void setIndividuelleBeitraege(Boolean individuellebeitraege) throws RemoteException {
    setAttribute("individuellebeitraege", Boolean.valueOf(individuellebeitraege));
  }
  ...
  public void setExterneMitgliedsnummer(Boolean externemitgliedsnummer) throws RemoteException {
    setAttribute("externemitgliedsnummer", Boolean.valueOf(externemitgliedsnummer));
  }
  ...
  @Override
  public void setVorlagenCsvVerzeichnis(String vorlagencsvdir) throws RemoteException {
  ...
  public void setSpendenbescheinigungverzeichnis(String spendenbescheinigungverzeichnis)
      throws RemoteException {
    setAttribute("spendenbescheinigungverzeichnis", spendenbescheinigungverzeichnis);
  }
  ...
  public void setSpendenbescheinigungPrintBuchungsart(Boolean printbuchungsart)
      throws RemoteException {
    setAttribute("spendenbescheinigungprintbuchungsart", Boolean.valueOf(printbuchungsart));
  }
  ...
  public String getSmtpAuthPwd() throws RemoteException {
    if (this.smtp_auth_pwd == null) {
      try {
        ...
        Logger.error("Fehler beim Auslesen des SMTP-Passworts aus dem Wallet", e);
      }
    }
  ...
  public String getImapAuthPwd() throws RemoteException {
    if (imap_auth_pwd == null) {
      try {
        ...
        Logger.error("Fehler beim Auslesen des IMAP-Passworts aus dem Wallet", e);
      }
    }
  ...
  @Override
  public void setZusatzbetragAusgetretene(boolean zusatzbetragausgetretene) throws RemoteException {
    setAttribute("zusatzbetragausgetretene", Boolean.valueOf(zusatzbetragausgetretene));
  }
