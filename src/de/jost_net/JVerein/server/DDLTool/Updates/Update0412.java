...
public class Update0412 extends AbstractDDLUpdate
{
  public Update0412(String driver, ProgressMonitor monitor, Connection conn)
  {
  ...
  {
    // Buchungsart in den Zusatzbeträgen
    execute(addColumn("zusatzabbuchung", new Column("buchungsart",
