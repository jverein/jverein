...
public class Update0415 extends AbstractDDLUpdate
{
  public Update0415(String driver, ProgressMonitor monitor, Connection conn)
  {
  ...
  {
    execute(createForeignKey("FKZusatzbetragvorlage_2", "zusatzbetragvorlage",
