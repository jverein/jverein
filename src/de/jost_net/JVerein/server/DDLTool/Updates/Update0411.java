...
public class Update0411 extends AbstractDDLUpdate
{
  public Update0411(String driver, ProgressMonitor monitor, Connection conn)
  {
  ...
  public void run() throws ApplicationException
  {
    ...
    execute(addColumn("einstellung", new Column("kursteilnehmergebgespflicht",
