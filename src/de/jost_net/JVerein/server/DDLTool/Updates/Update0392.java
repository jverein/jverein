...
public class Update0392 extends AbstractDDLUpdate
{
  public Update0392(String driver, ProgressMonitor monitor, Connection conn)
  {
  ...
  {
    execute(addColumn("einstellung", new Column("sekundaerebeitragsgruppen",
        COLTYPE.BOOLEAN, 10, null, false, false)));
  }
}
