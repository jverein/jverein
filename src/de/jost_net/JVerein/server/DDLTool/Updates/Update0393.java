...
public class Update0393 extends AbstractDDLUpdate
{
  public Update0393(String driver, ProgressMonitor monitor, Connection conn)
  {
  ...
  {
    execute(addColumn("beitragsgruppe", new Column("sekundaer",
