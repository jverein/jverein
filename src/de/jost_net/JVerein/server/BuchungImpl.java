...
public class BuchungImpl extends AbstractDBObject implements Buchung {
  ...
  protected void insertCheck() throws ApplicationException {
    try {
      ...
      throw new ApplicationException("Buchung kann nicht gespeichert werden. Siehe system log");
    }
  }
  ...
  public Map<String, Object> getMap(Map<String, Object> inma) throws RemoteException {
    ...
    if (this.getProjekt() != null) {
      ...
      map.put(BuchungVar.PROJEKTBEZEICHNUNG.getName(), this.getProjekt().getBezeichnung());
    } else {
