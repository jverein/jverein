 ...
 * Aktuelle Geburtstage und Wiedervorlage ausgemustert. Ersatz durch die neue Termin¸bersicht.
 *
 * Revision 1.41  2011-03-17 19:00:48  jost
 * Bugfix Feldname
 *
 * Revision 1.40  2011-03-13 13:43:36  jost
 * Zus‰tzliches Feld f. Sachspendenbescheinigungen.
 *
 ...
 * Sofortige ‹bernahme der ƒnderungen
 *
...
public class EinstellungControl extends AbstractControl
{
  ...
  public TextInput getBeguenstigterzweck() throws RemoteException
  {
    ...
    beguenstigterzweck = new TextInput(
        Einstellungen.getEinstellung().getBeguenstigterzweck(), 30);
    return beguenstigterzweck;
  }
