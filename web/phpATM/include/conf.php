...
//
$page_title = 'JVerein-Downloadbereich';
...
// 
//
$rejectedfiles = "^index\.|\.desc$|\.fdesc$|\.dlcnt$|\.vcnt$|\.php$|\.php\..*|\.php3$|\.php3\..*|\.cgi\..*|\.cgi$|\.pl$\.pl\..*|\.php4$|\.ns|\.inc$|\.php5";
...
// here you can allow some extra characters for usernames such as י ט ח א @
// but keep in mind that usernames are also filenames! not every character can be used!
// e.g. $extra_character = 'יטחא@';
$extra_character = "אב";
