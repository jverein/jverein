<? include ("frame.inc"); ?>
    <h1>Version 1.3.0</h1>
    <p>
    Die Version 1.3.0 wurde am 9.4.2010 freigegeben. Zu den wesentlichen Änderungen
    zählen:
    <ul>
    	...
    	<li>Im Bereich der Buchführung wurden Buchungsklassen zur Zusammenfassung von 
    	    ...
    	    <a href='buchfuehrungzusammenhaenge.php'>Zusammenhänge der Buchführung</a></li>
    	<li>Zusatzfeldern können jetzt Datentypen zugeordnet werden. Damit wird die 
    	    Sortierung vereinfacht und bei der Eingabe sind nur typkonforme Daten möglich
    	    (Datum, Zahl)</li>
    	<li>Erweiterung des Imports: Eigenschaften und Zusatzbeträge können jetzt importiert werden.</li>
